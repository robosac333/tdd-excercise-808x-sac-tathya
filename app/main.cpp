 ...
 * 
 * Intitialize an instance of PIDController, this would help in performing the basic PID controller loop.
 * It calculates the error, proportional, integral, and derivative terms, and adjusts the output value accordingly.
 * The output value is restricted between the defined max and min limits.
 * 
...
int main(){
    ...
    double integral = 0; // Initialize the Integral term.
    double pre_error = 0; // Initialize the Previous error term.
    ...
    for(int i = 0; i <= 100; i++){
        ...
        // Update the previous error value for the next iteration.
        pre_error = error;
