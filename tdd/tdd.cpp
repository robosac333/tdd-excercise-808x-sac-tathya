...
PIDController::PIDController(double Kp_, double Ki_, double Kd_,
                             double setpoint, double current_value, double dt_,
...
/**
 * @brief Computing the error between the setpoint and current value that would
 * be used to compute the proportional, integral and derivative gains.
 *
 * @param setpoint Desired target value.
 * @param current_value Current system output.
 ...
 *
 * To get the final output of the PID controller this method combines the
